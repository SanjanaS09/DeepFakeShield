...
"""
Image-based deepfake detection using ResNet18
"""
...
class ImageDeepfakeDetector:
    """Wrapper class for image deepfake detection"""
    
    def __init__(self, model_path='checkpoints/image/best_model.pth', device='cpu'):
    ...
    def _load_model(self, model_path):
        ...
        try:
            ...
            if 'model_state_dict' in checkpoint:
                ...
                logger.info(f"✓ Loaded ResNet18 from epoch {checkpoint.get('epoch', 'N/A')}")
            else:
                model.load_state_dict(checkpoint)
                logger.info("✓ Loaded ResNet18 model")
