      ...
      {result.xai && (
        <div className="xai-section">
          ...
          <div className="xai-summary">
            <p><strong>Explanation:</strong> {result.xai.explanation}</p>
            <p><strong>Confidence Level:</strong> {result.xai.confidence_level}</p>
          </div>

          {result.xai.reasoning && (
          ...
          {result.xai.key_indicators && (
            <div className="xai-indicators">
          ...
          {result.xai.recommendations && (
            <div className="xai-recommendations">
              <h4>Recommendations</h4>
              <ul>
                {result.xai.recommendations.map((rec, idx) => (
                  <li key={idx}>{rec}</li>
                ))}
              </ul>
            </div>
...
//               <div className="prob-value">{realPct}%</div>
//               <div className="prob-bar">
//                 <div className="prob-fill real-fill" style={{ width: `${realPct}%` }} />
//               </div>
//             </div>
...
//               <div className="prob-value">{fakePct}%</div>
//               <div className="prob-bar">
//                 <div className="prob-fill fake-fill" style={{ width: `${fakePct}%` }} />
//               </div>
//             </div>
//           </div>
//         </div>
